...
<?php
	if($argc == 2)
	{
		...
		if ((preg_match("/(^[L|l]undi|^[M|m]ardi|^[M|m]ercredi|^[J|j]eudi|^[V|v]endredi|^[S|s]amedi|^[D|d]imanche)( )([1-9]{1}|[0-3]{1}[0-9]{1})( )([J|j]anvier|[F|f]evrier|[M|m]ars|[A|a]vril|[M|m]ai|[J|j]uin|[J|j]uillet|[A|a]out|[S|s]eptembre|[O|o]ctobre|[N|n]ovembre|[D|d]ecembre)( )([1-2]{1}[0-9]{3})( )([0-2]{1}[0-9]{1}:[0-6]{1}[0-9]{1}:[0-6]{1}[0-9]{1})$/", $argv[1])) == 1)
		{
			$arr = explode(" ", $argv[1]);
			$time = explode(':', $arr[4]);
			...
			$month = array("1" => "janvier","2" => "fevrier","3" => "mars", "4" => "avril", "5" => "mai", "6" => "juin" , "7" => "juillet", "8" => "aout", "9" => "septembre", "10" => "octobre", "11" => "novembre", "12" => "decembre");
			$monthbig = array("1" => "Janvier","2" => "Fevrier","3" => "Mars", "4" => "Avril", "5" => "Mai", "6" => "Juin" , "7" => "Juillet", "8" => "Aout", "9" => "Septembre", "10" => "Octobre", "11" => "Novembre", "12" => "Decembre");
